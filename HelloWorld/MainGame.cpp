...
void MainGameEntry(PLAY_IGNORE_COMMAND_LINE)
{
	...
	int Agent8ID = Play::CreateGameObject(TYPE_AGENT8, { 115, 600 }, 50, "agent8");
...
void HandlePlayerControls()
{
	...
	Play::DrawLine({ obj_agent8.pos.x, DISPLAY_HEIGHT }, obj_agent8.pos, Play::cWhite);
